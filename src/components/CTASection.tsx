  ...
  return (
    <section className="py-24 px-6 relative overflow-hidden bg-indigo-600">
      ...
      <div className="max-w-4xl mx-auto relative z-10 text-center">
        <FadeIn className="bg-white/10 backdrop-blur-xl border border-white/20 p-10 md:p-16 rounded-[3rem] shadow-2xl">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <a 
              ...
              target="_blank"
              rel="noreferrer"
              className="w-full sm:w-auto bg-[#25D366] hover:bg-[#1faa53] text-white px-8 py-5 rounded-xl font-bold text-lg flex items-center justify-center gap-3 transition-all duration-300 transform hover:scale-105 shadow-[0_8px_30px_rgba(37,211,102,0.3)] animate-[pulse_3s_ease-in-out_infinite]"
            >
            ...
            <a 
              href="#contact" 
              className="w-full sm:w-auto bg-white hover:bg-slate-50 text-indigo-900 px-8 py-5 rounded-xl font-bold text-lg flex items-center justify-center gap-3 transition-all duration-300 hover:scale-105 shadow-xl hover:shadow-indigo-500/20"
            >
              <Calendar size={24} />
              Book Free Call
            </a>
