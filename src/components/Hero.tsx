...
const Hero = () => {
  ...
  // Optimize animation transitions for mobile
        ...
        {!isMobile && (
          ...
          >
            ...
            <div className="absolute inset-0 w-full h-full">
              {/* Desktop Mockup */}
              <div className="absolute top-0 right-0 w-[85%] aspect-[16/10] bg-white rounded-2xl shadow-[0_20px_50px_rgba(0,0,0,0.1)] border border-slate-200 overflow-hidden">
                {/* Browser Header */}
