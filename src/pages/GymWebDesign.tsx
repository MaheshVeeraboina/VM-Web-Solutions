import heroImage from '@/assets/images/gym-mockup.webp';
...
const GymWebDesign = () => {
  ...
  return (
    <main className="bg-slate-50 min-h-screen">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              <div className="aspect-[4/3] rounded-2xl overflow-hidden shadow-2xl border-4 border-white/50 relative z-10 bg-slate-900">
                <img src={heroImage} alt="Gym Web Design Mockup" width="1200" height="800" fetchPriority="high" loading="eager" decoding="sync" className="w-full h-full object-cover" />
              </div>
      ...
      <RelatedPages currentPath="/gym-website-developer-india" title="Explore Our Other Service Specializations" />
    </main>
  );
};
