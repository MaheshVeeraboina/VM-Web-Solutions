...
import desktopAvif from '@/assets/images/coaching-mockup.png?w=400;800;1200&format=avif&as=srcset';
import desktopWebp from '@/assets/images/coaching-mockup.png?w=400;800;1200&format=webp&as=srcset';
import desktopSrc from '@/assets/images/coaching-mockup.png?w=1200&as=src';
import desktopLqip from '@/assets/images/coaching-mockup.png?w=20&format=webp&blur=10&inline';
            ...
            >
              <div className="aspect-[4/3] rounded-2xl overflow-hidden shadow-2xl border-4 border-white/50 relative z-10 bg-slate-50">
                <OptimizedPicture 
                  ...
                  lqip={desktopLqip}
                  alt="Coaching Institute Web Design Mockup"
